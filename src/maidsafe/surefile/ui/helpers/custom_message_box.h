...
#ifndef MAIDSAFE_SUREFILE_UI_HELPERS_CUSTOM_MESSAGE_BOX_H_
#define MAIDSAFE_SUREFILE_UI_HELPERS_CUSTOM_MESSAGE_BOX_H_
...
#endif  // MAIDSAFE_SUREFILE_UI_HELPERS_CUSTOM_MESSAGE_BOX_H_
